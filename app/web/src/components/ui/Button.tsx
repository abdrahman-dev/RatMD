  ...
  ({ className, variant = 'primary', size = 'md', children, isLoading, disabled, ...props }, ref) => {
    return (
      <button
        ...
        className={cn(
          'inline-flex items-center justify-center gap-2 font-mono font-medium rounded-lg transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer',
